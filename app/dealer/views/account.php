...
<body>
  ...
  <header>
    <h1>Dealer - Account Management</h1>
  </header>
  ...
  <main class="container">
      ...
      <div style="display:flex; gap:20px; flex-wrap:wrap;">
        ...
        <div class="box" style="flex:1; min-width:320px;">
          ...
          <form id="profileForm" method="post" action="index.php?url=dealer/update_profile">
            ...
            <div class="form-group">
              ...
              <input type="text" name="shop_name" value="<?php echo $user['shop_name'] ?? ''; ?>" required>
            </div>
        ...
        <div class="box" style="flex:1; min-width:320px;">
          ...
          <form id="passwordForm" method="post" action="index.php?url=dealer/change_password">
            <div class="form-group">
          ...
          <form id="deleteForm" method="post" action="index.php?url=dealer/delete_account">
      ...
      <div class="center" style="margin-top:15px;">
        <a class="btn" href="index.php?url=dealer/dashboard">← Back to Dashboard</a>
      </div>
